export const es = {
  ...
  onboarding: {
    ...
    fullNamePlaceholder: 'Ej. María Fernanda López Hernández',
  ...
  admin: {
    ...
    members: {
      loading: 'Cargando…',
      unavailable: 'Esta sección necesita el backend de Firestore configurado.',
      arrivedTitle: 'Recibidos del formulario',
      arrivedLede: 'Respuestas del formulario de incorporación, listas para publicarse.',
      arrivedEmpty: 'No hay respuestas pendientes.',
      publishedTitle: 'Perfiles publicados',
      publishedLede: 'Perfiles guardados en la base de datos.',
      publishedEmpty: 'Todavía no hay perfiles publicados.',
      addManually: '+ Añadir a mano',
      addTitle: 'Añadir perfil',
      ...
      readyWithQueries: 'Requiere revisión: {values}',
      unresolvedNotice: 'No se pudieron reconocer estos valores del formulario:',
      ...
      seedNotice: 'Mientras no haya perfiles publicados, el directorio público muestra {count} perfiles incluidos en el código. Al publicar el primero, dejan de mostrarse.',
      ...
      jobPositionName: 'Puesto',
      jobPositionNameHint: 'Como lo escribe la persona.',
      affiliation: 'Afiliación',
      affiliationHint: 'Déjalo vacío si participa de forma independiente.',
      noAffiliation: 'Sin afiliación',
      country: 'País',
      region: 'Región',
      biography: 'Biografía',
      biographyHint: 'Texto breve, en su idioma.',
      socialUrl: 'Perfil o sitio',
      socialUrlHint: 'Debe empezar por https://',
      interests: 'Intereses',
      areas: 'Áreas generales',
      languages: 'Idiomas',
      max: 'Máximo {n}.',
      errors: {
        generic: 'No se pudo guardar.',
        'missing-required': 'Faltan campos obligatorios.',
        'invalid-email': 'Correo no válido.',
        'invalid-location': 'El país y la región no coinciden.',
        'invalid-affiliation': 'Afiliación no reconocida.',
        'missing-interests': 'Selecciona al menos un interés.',
        'missing-areas': 'Selecciona al menos un área.',
        'missing-languages': 'Selecciona al menos un idioma.',
        'invalid-url': 'El enlace no es válido.',
        'too-long': 'Algún campo es demasiado largo.',
        'consent-required': 'La respuesta no autoriza la publicación del perfil.',
        'no-recognised-columns': 'No se reconoció ninguna pregunta del formulario.',
        'not-found': 'No se encontró la respuesta.',
    ...
    congress: {
      ...
      photosLabel: 'Fotos',
      photosHint:
        'Hasta {max}. Se pega el enlace de una imagen que ya esté publicada en internet (https://); desde aquí no se suben archivos.',
      photoUrlLabel: 'Enlace de la imagen',
      photoAltLabel: 'Descripción de la foto {n}',
      photoAltHint: 'Para quien no puede ver la imagen. Describe qué se ve.',
      addPhoto: 'Añadir foto',
      removePhoto: 'Quitar',
      movePhotoUp: 'Subir',
      movePhotoDown: 'Bajar',
      photoUrlInvalid: 'El enlace de la foto {n} debe empezar con https://',
      photoAltMissing: 'Falta la descripción de la foto {n} en español.',
...
export const en: Dictionary = {
  ...
  onboarding: {
    ...
    fullName: 'Full name',
    fullNamePlaceholder: 'e.g. María Fernanda López Hernández',
    email: 'Email address',
  ...
  admin: {
    ...
    members: {
      loading: 'Loading…',
      unavailable: 'This section needs the Firestore backend configured.',
      arrivedTitle: 'Arrived from the form',
      arrivedLede: 'Incorporation-form responses, ready to publish.',
      arrivedEmpty: 'No responses waiting.',
      publishedTitle: 'Published profiles',
      publishedLede: 'Profiles stored in the database.',
      publishedEmpty: 'No profiles published yet.',
      ...
      readyWithQueries: 'Needs review: {values}',
      unresolvedNotice: 'These answers from the form could not be recognised:',
      ...
      seedNotice: 'While no profiles are published, the public directory shows {count} profiles compiled into the code. Publishing the first one replaces them.',
      unknownName: 'No name',
      ...
      jobPositionName: 'Job title',
      jobPositionNameHint: 'As the person writes it themselves.',
      affiliation: 'Affiliation',
      affiliationHint: 'Leave empty for an independent member.',
      noAffiliation: 'No affiliation',
      country: 'Country',
      region: 'Region',
      biography: 'Biography',
      biographyHint: 'Short text, in their own language.',
      socialUrl: 'Profile or site',
      socialUrlHint: 'Must start with https://',
      interests: 'Interests',
      areas: 'General areas',
      languages: 'Languages',
      max: 'Up to {n}.',
      errors: {
        ...
        'missing-required': 'Required fields are missing.',
        'invalid-email': 'Invalid email address.',
        'invalid-location': 'The country and region do not match.',
        'invalid-affiliation': 'Affiliation not recognised.',
        'missing-interests': 'Select at least one interest.',
        'missing-areas': 'Select at least one area.',
        'missing-languages': 'Select at least one language.',
        'invalid-url': 'That link is not valid.',
        'too-long': 'A field is too long.',
        'consent-required': 'The response does not consent to a public profile.',
        'no-recognised-columns': 'No form question was recognised.',
        'not-found': 'Response not found.',
        'request-failed': 'The operation could not be completed.',
      },
    },
    footerNote:
    ...
    congress: {
      ...
      photosLabel: 'Photos',
      photosHint:
        'Up to {max}. Paste the link to an image that is already online (https://); files are not uploaded here.',
      photoUrlLabel: 'Image link',
      photoAltLabel: 'Description of photo {n}',
      photoAltHint: 'For people who cannot see the image. Describe what it shows.',
      addPhoto: 'Add photo',
      removePhoto: 'Remove',
      movePhotoUp: 'Move up',
      movePhotoDown: 'Move down',
      photoUrlInvalid: 'The link for photo {n} must start with https://',
      photoAltMissing: 'The description of photo {n} is missing in Spanish.',
...
export const pt: Dictionary = {
  ...
  onboarding: {
    ...
    fullNamePlaceholder: 'Ex. María Fernanda López Hernández',
    email: 'E-mail',
  ...
  admin: {
    ...
    members: {
      loading: 'Carregando…',
      unavailable: 'Esta seção precisa do backend do Firestore configurado.',
      arrivedTitle: 'Recebidos do formulário',
      arrivedLede: 'Respostas do formulário de incorporação, prontas para publicar.',
      arrivedEmpty: 'Nenhuma resposta pendente.',
      publishedTitle: 'Perfis publicados',
      publishedLede: 'Perfis armazenados no banco de dados.',
      publishedEmpty: 'Ainda não há perfis publicados.',
      ...
      readyWithQueries: 'Precisa de revisão: {values}',
      unresolvedNotice: 'Estes valores do formulário não foram reconhecidos:',
      receivedOn: 'Recebido em {date}',
      ...
      seedNotice: 'Enquanto não houver perfis publicados, o diretório público mostra {count} perfis compilados no código. Ao publicar o primeiro, eles deixam de aparecer.',
      ...
      fullName: 'Nome completo',
      position: 'Tipo de cargo',
      jobPositionName: 'Cargo',
      jobPositionNameHint: 'Como a própria pessoa escreve.',
      affiliation: 'Afiliação',
      affiliationHint: 'Deixe vazio para membro independente.',
      noAffiliation: 'Sem afiliação',
      country: 'País',
      region: 'Região',
      biography: 'Biografia',
      biographyHint: 'Texto curto, no idioma da pessoa.',
      socialUrl: 'Perfil ou site',
      socialUrlHint: 'Deve começar com https://',
      interests: 'Interesses',
      areas: 'Áreas gerais',
      languages: 'Idiomas',
      max: 'No máximo {n}.',
      errors: {
        generic: 'Não foi possível salvar.',
        'missing-required': 'Faltam campos obrigatórios.',
        'invalid-email': 'E-mail inválido.',
        'invalid-location': 'O país e a região não coincidem.',
        'invalid-affiliation': 'Afiliação não reconhecida.',
        'missing-interests': 'Selecione ao menos um interesse.',
        'missing-areas': 'Selecione ao menos uma área.',
        'missing-languages': 'Selecione ao menos um idioma.',
        'invalid-url': 'O link não é válido.',
        'too-long': 'Algum campo é muito longo.',
        'consent-required': 'A resposta não autoriza a publicação do perfil.',
        'no-recognised-columns': 'Nenhuma pergunta do formulário foi reconhecida.',
        'not-found': 'Resposta não encontrada.',
        'request-failed': 'A operação não pôde ser concluída.',
      },
    },
    footerNote:
    ...
    congress: {
      ...
      photosLabel: 'Fotos',
      photosHint:
        'Até {max}. Cole o link de uma imagem que já esteja publicada na internet (https://); daqui não se enviam arquivos.',
      photoUrlLabel: 'Link da imagem',
      photoAltLabel: 'Descrição da foto {n}',
      photoAltHint: 'Para quem não pode ver a imagem. Descreva o que aparece.',
      addPhoto: 'Adicionar foto',
      removePhoto: 'Remover',
      movePhotoUp: 'Subir',
      movePhotoDown: 'Descer',
      photoUrlInvalid: 'O link da foto {n} deve começar com https://',
      photoAltMissing: 'Falta a descrição da foto {n} em espanhol.',
